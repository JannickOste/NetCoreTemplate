...
public class UserController : Controller
{
    ...
    private readonly IEntityRemapper<UserCreateViewModel, User> createMapper;
    private readonly IEntityRemapper<UserUpdateViewModel, User> updateMapper;
    ...
    public ActionResult Update(int id, [FromBody] UserUpdateViewModel userUpdateViewModel)
    {
        ...
        User updatedUser = this.updateMapper.Copy(userUpdateViewModel, user);
